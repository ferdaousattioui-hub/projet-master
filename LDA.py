...
# 4. Création du Dashboard de résultats
...
plt.savefig('resultats_lda_final.png', dpi=300, bbox_inches='tight')
print("✅ Image sauvegardée sous le nom : resultats_lda_final.png")
plt.show()
